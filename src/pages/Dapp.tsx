        ...
        <div style={styles.container}>
            ...
            <div style={styles.header}>
                <div style={styles.headerContainer}>
                    <h1 style={styles.title}>🧧 智能合约红包系统</h1>
                    <WalletConnection
                        account={account}
                ...
                {account && authorizedAccounts.length > 1 && (
                    ...
                    >
                        ...
                        >
                            <span>⚡</span>
                            <span>
                                检测到 {authorizedAccounts.length}{' '}
                                个已授权账户，可以通过钱包菜单快速切换，完全无需 MetaMask 确认
                            </span>
                        </div>
                    </div>
                )}
                ...
                {account ? (
                    <>
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    >
                                        {contractOwner}
                                        {isOwner && (
                                            <span style={{ color: '#2ed573', marginLeft: '8px' }}>
                                                （您）
                                            </span>
                                        )}
                                    </p>
                        ...
                        <div style={styles.card}>
                                        ...
                                        >
                                            ...
                                            <div>
                                                ...
                                                <div
                                                    style={{ fontSize: '18px', fontWeight: 'bold' }}
                                                >
                                                    {redPacketInfo.distributedAmount} ETH
                                                </div>
                                            </div>
                                            <div>
                                                <div
                                                ...
                                                <div
                                                    style={{ fontSize: '18px', fontWeight: 'bold' }}
                                                >
                                                    {redPacketInfo.claimedCount}/
                                                    {contractConstants.maxRecipients}
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div style={{ marginTop: '20px' }}>
                                            ...
                                            >
                                                <div
                                                    style={{
                                                        background:
                                                            'linear-gradient(90deg, #2ed573, #26d46c)',
                                                        height: '100%',
                            ...
                            {/* 提示信息 */}
                            {redPacketInfo &&
                                redPacketInfo.claimedCount >= contractConstants.maxRecipients &&
                                !userHasClaimed && (
                                    <div
                                        style={{
                        ...
                        <div style={styles.card}>
                            ...
                            <div style={{ lineHeight: '1.8', fontSize: '16px' }}>
                                <p style={{ marginBottom: '12px' }}>
                                    🎯 <strong>合约拥有者</strong>
                                    ：可以向红包合约充值，设定总金额和最大领取人数
                                </p>
                                <p style={{ marginBottom: '12px' }}>
                                    🧧 <strong>用户</strong>
                                    ：连接钱包后可以领取红包，每个地址只能领取一次
                                </p>
                                <p style={{ marginBottom: '12px' }}>
                                    🎲 <strong>随机分配</strong>
                                    ：系统会根据算法随机分配每个红包的金额
